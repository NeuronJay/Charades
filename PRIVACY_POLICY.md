Charades Privacy Policy 
Last updated [April, 2020]
This policy is effective as of 2020-04-18
 
Script Studios built the Charades app as a Free app. This SERVICE is provided by Script Studios at no cost and is intended for use as is.
 
Script Studios (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile application (the “Application”). Please read this Privacy Policy carefully. IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT ACCESS THE APPLICATION.
...
Information our servers automatically collect when you access the Application, such as your native actions that are integral to the Application, including maybe swiping the cards, the specific history, liking, re-blogging, or replying to a post, as well as other interactions with the Application and other users via server log files.

Data from Social Networks

User information from social networking sites, such as [ Facebook, Instagram, Snapchat and other social media sites that we connect to], including your name, your social network username, location, gender, birth date, email address, profile picture, and public data for contacts, if you connect your account to such social networks. This information may also include the contact information of anyone you invite to use and/or join the Application. The friends list or the connection will be used to maintain the leaderboard and have in game better experience. For more information regarding social media related sites for example Facebook permissions, refer to the respected sites for example  Facebook Permissions Reference page. 
...
We may request access or permission to certain features from your mobile device, including your mobile device’s [bluetooth, wifi]. If you wish to change our access or permissions, you may do so in your device’s settings. We will use the access to improve the local connections and levels in the game. 
...
Personal and other information you may provide when entering contests or giveaways and/or responding to surveys or for free coins in respect to the game. 
...
We may share your information with third parties with whom we have collaborated on personal levels regarding the type of data collection, user behaviour analysis and other matters as discussed in the agreement as per the respective company.
...
We solicit information from all users irrespective of the age for enhancing their gaming experience. No whatsoever content is specially filtered or targeted to children below 12 years of age. 
...
Script Studios 
A105, HOR MEN, DAIICT College
Gandhinagar, Gujarat - 382007
+91 9426 013 524
studios.script@gmail.com
